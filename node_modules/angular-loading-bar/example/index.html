...
<div class="jumbotron">
  ...
  <p>An automatic loading bar using angular interceptors.
    <small> It works automatically, so simply include it as a dependency and it will automatically display the progress
...
<div class="examples" ng-hide="fakeIntro">
  ...
  <div class="btn-group btn-group-justified">
    ...
    <a href="#" class="btn btn-primary btn-lg" ng-click="fetch()"><i class="glyphicon glyphicon-play-circle"></i> Real
      Example <span> (from reddit)</span></a>
  </div>
</div>
